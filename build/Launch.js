...
const Minecraft_Logging_js_1 = __importDefault(require("./Minecraft/Minecraft-Logging.js"));
...
class Launch extends events_1.EventEmitter {
    ...
    async DownloadGame() {
        ...
        const java = new Minecraft_Java_js_1.default(this.options);
        ...
        const gameAssets = await new Minecraft_Assets_js_1.default(this.options).getAssets(json);
        await new Minecraft_Logging_js_1.default(this.options).getLogging(json);
        ...
        if (this.options.loader.enable === true) {
            const loaderInstall = new Minecraft_Loader_js_1.default(this.options);
