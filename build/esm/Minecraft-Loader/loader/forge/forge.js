...
import { getPathLibraries, getFileHash, mirrors, getFileFromArchive, skipLibrary } from '../../../utils/Index.js';
...
export default class ForgeMC extends EventEmitter {
    ...
    async downloadInstaller(Loader) {
        ...
        if (!metaDataList.ok) {
            metaDataList = fs.readFileSync(path.resolve(__dirname, '../../../../assets/forge', 'forge-metadata.json'), 'utf-8');
